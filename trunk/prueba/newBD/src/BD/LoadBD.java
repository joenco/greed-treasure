...
public class LoadBD {
        ...
        public static char [][] loadDataPrueba(int userIdInt){
              ...
              case 1 ://prototipo matriz donde el castillo es "1"
                  char [][] r1 = {   {'a','a','a','a','a','B','a','a','a','a','B','a','a','a','a','a'},
                ...
                break;
      case 2 :
                  char [][] r2 = {  {'g','g','g','g','y','g','g','g','g','g','g','y','g','g','g','g'},
                ...
                // Etc...
                          break;
              case 3 :
                  char [][] r3 =  {  {'d','d','d','d','y','d','d','d','d','d','d','y','d','d','d','d'},
                ...
                break;
              case 4 :
                  char [][] r4 = {	{'e','t','e','u','e','u','e','t','u','t','e','u','e','u','e','t'},
                ...
                break;
              case 5 :
                  char [][] r5 = { {'l','l','l','l','l','l','l','k','k','l','l','l','l','l','l','l'},
      ...
      default :
        ...
        public static void crearTile(char charId, boolean esOcupable, int bonusVida, int ataqueAgregado, int defensaAgregada, String ruta) throws Exception {
