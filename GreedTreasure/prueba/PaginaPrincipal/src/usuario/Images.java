...
public class Images extends Panel {
  ...
  /**/"http://www.gstatic.com/codesite/ph/images/defaultlogo.png", //
      "images/acercademinotauroh2.jpg", //
      "images/acercademinotauroh3.jpg"};
  ...
  private Label lblData;
    ...
    for (int i = 0; i < labelCount; i++) {
      ...
      // ¿Por qué aquí no hace falta el cache?
      ImageReference ir = new HttpImageReference(imagePath[currentImageIndex]);
